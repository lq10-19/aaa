<template>
  <div class="body_box">
    ...
    <div class="color_666 top_4">本授权书所指的本人信息包括本人基本信息、本人信贷信息以及与本人信用相关的其他信息</div>
    <div class="color_666 top_4">二、信息查询期限</div>
    <div
      class="color_666 indent top_1"
    ...
    <div class="color_666 top_4">三、本人同意被授权人向百行征信有限公司报送本人信息（含历史信息、不良信息、负债信息及偿债履约能力判断信息等）。</div>
    <div
      class="color_666 top_4"
    ...
    <div class="color_666 indent top_1">
      本人已知悉并理解本授权书所有内容
...
<script>
import { getNowFormatDate, storeGet, storeSet } from "../../utils/common.js";
...
export default {
  ...
  created() {
    ...
    if (idCardOcr) {
      this.name = idCardOcr.name;
      this.idcard = idCardOcr.idcard;
    } else {
      Toast("未获取到个人信息");
    }
  },
  mounted() {
    if (this.name && this.idcard) {
      ...
      documentTemp.personalAuthorization = 1;
      storeSet(documentTemp, "documentTemp");
    }
  }
};
</script>
